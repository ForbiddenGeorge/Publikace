  ...
  const handleAddAuthor = async () => {
    ...
    try {
      ...
      if (selectedPublication) {
        ...
        //volám samotnou mutaci s potřebnými proměnými
        {
        ...
        dispatch(InsertAuthor({
          author: data.data.authorInsert.author,
          publicationId: selectedPublication.id
        }));
